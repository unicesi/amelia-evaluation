...
public class Bridge_Server extends Subsystem.Deployment {
  private Host host;
  ...
  public final CommandDescriptor[] executeBridge = new CommandDescriptor[1];
  
  public final CommandDescriptor[] executeServer = new CommandDescriptor[1];
  
  public Bridge_Server() {
    
  }
  
  public Bridge_Server(final Host host, final Integer numComponents) {
    this.host = host;
  ...
  private void init() {
    ...
    executeBridge[0] = initExecuteBridge0();
    executeServer[0] = initExecuteServer0();
  ...
  public void setup() {
    ...
    executeBridge[0].runsOn(hosts0);
    executeBridge[0].dependsOn(directory[0]);
    executeServer[0].runsOn(hosts0);
    executeServer[0].dependsOn(executeBridge[0]);
  }
  ...
  private CommandDescriptor initExecuteBridge0() {
    return Commands.run()
        .withComposite("procedimientos_bridge_" + 12 + "_" + this.numComponents + "")
  ...
  private CommandDescriptor initExecuteServer0() {
    return Commands.run()
        .withComposite("procedimientos_server")
        .withLibpath(Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList("jars/xmlServerReactorRest.jar", "lib/vtd-xml.jar", "lib/org.pascani.dsl.lib-0.0.1-SNAPSHOT-dependencies.jar", "lib/new-personalized-events-with-carvajal.jar", "lib/ojdbc6.jar", "lib/javax.ws.rs-api-2.0.jar", "lib/commons-codec-1.10.jar", "lib/xdb6.jar"))).build();
  }
